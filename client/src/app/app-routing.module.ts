...
import { Mode1ListComponent} from './pages/mode1list/mode1list.component';
...
const routes: Routes = [
    ...
    { path: 'mode1s',  loadChildren: './pages/mode1list/mode1list.module#Mode1ListModule' , canActivate: [AuthGuard] },
